...
class PhpVimeoHelper
{
	 ...
	 * Construct function
	 * 
	 * @param   unknown_type  $consumer_key     No comment
	 * @param   unknown_type  $consumer_secret  No comment
	 * @param   unknown_type  $token            No comment
	 * @param   unknown_type  $token_secret     No comment
	 */
     ...
     *
     * @param   array   $params          The full list of args to generate the signature for.
     ...
     * @param   string  $callback_url  Comment
     * 
     * @return  null
     */
     ...
     * 
     * @param   string  $file_name  Comment
     * @param   int     $size       Comment
     * 
     * @deprecated
     * 
     * @return null
